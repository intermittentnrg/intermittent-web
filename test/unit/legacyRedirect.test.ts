...
describe("legacyDashboardRedirect", () => {
  it("translates legacy simulation dashboard URL params", async () => {
    await expectLegacyRedirect(
      ...
      "/usa/balancing_authority/CAISO/1_year_ago_to_now/simulation?min_resolution=1d&production_type=battery%2Cbiogas%2Cbiomass%2Cgeothermal%2Chydro_large%2Chydro_small%2Cnuclear%2Cother%2Csolar%2Cwind_onshore&nuclear_multiplier=6&wind_multiplier=1&solar_multiplier=1.5&demand_multiplier=1",
    );
  });
